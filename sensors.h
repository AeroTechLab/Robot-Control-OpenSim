...
///   "conversion_curve": "<curve_identifier>", // Curve configuration string identifier or data object, if needed for more complex relation between raw and processed values
...
/// Sensors interface generation macro
#define SENSOR_INTERFACE( Namespace, INIT_FUNCTION ) \
        INIT_FUNCTION( Sensor, Namespace, Init, DataHandle ) \
...
/// @struct Sensors
/// @brief Function pointer struct as sensors interface  
///
/// @memberof Sensors
/// @fn Sensor Init( DataHandle configuration )                                                                          
...
///
/// @memberof Sensors
/// @fn void Reset( Sensor sensor )
/// @brief Resets signal processing state and possible sensor device errors      
/// @param[in] sensor reference to sensor
///
/// @memberof Sensors
/// @fn void SetState( Sensor sensor, enum SignalProcessingPhase newProcessingPhase )
